...
auth_url = 'https://192.168.8.221/api/mo/aaaLogin.json'
...
if nei_count > 1:
    while counter < nei_count:
        ...
        if local_int != 'mgmt0':
            ...
            int_url = 'https://192.168.8.221/api/mo/sys/intf/phys-['+int_name+str(
    ...
    local_int = response['ins_api']['outputs']['output']['body'][
        'TABLE_cdp_neighbor_brief_info']['ROW_cdp_neighbor_brief_info']['intf_id']
    # print(local_int)
    remote_int = response['ins_api']['outputs']['output']['body'][
        'TABLE_cdp_neighbor_brief_info']['ROW_cdp_neighbor_brief_info']['port_id']
    counter += 1
